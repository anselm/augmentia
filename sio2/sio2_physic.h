...
#ifndef SIO2_PHYSIC_H
#define SIO2_PHYSIC_H
...
{
	btDbvtBroadphase *_btDbvtBroadphase = ( btDbvtBroadphase * )_SIO2physic->_btBroadphaseInterface;
	
	_btDbvtBroadphase->optimize();
}
