...
static inline float sio2FontGetPxWidth( SIO2font *_SIO2font,
										char	 *_str )
{ return sio2StringLen( _str ) * _SIO2font->space; }


static inline float sio2FontGetHalfPxWidth( SIO2font *_SIO2font,
										    char	 *_str )
{ return ( ( sio2StringLen( _str ) * _SIO2font->space ) * 0.5f ) - ( _SIO2font->space * 0.5f ); }
