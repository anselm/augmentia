...
SIO2frame *sio2FrameInit( unsigned int _frame,
						  unsigned int _size )
{
	SIO2frame *_SIO2frame = ( SIO2frame * )calloc( 1, sizeof( SIO2frame ) );

	_SIO2frame->frame = _frame;

	_SIO2frame->buf = ( unsigned char * )malloc( _size );
...
void sio2FrameSetCallback( SIO2frame		 *_SIO2frame,
						   SIO2framecallback *_SIO2framecallback )
{ _SIO2frame->_SIO2framecallback = _SIO2framecallback; }
