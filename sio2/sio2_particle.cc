...
{
	SIO2particle *_SIO2particle = ( SIO2particle * )calloc( 1, sizeof( SIO2particle ) );
	
	_SIO2particle->loc = sio2Vec3Init();
	_SIO2particle->col = sio2Vec4Init();
	
	return _SIO2particle;
}


SIO2particle *sio2ParticleFree( SIO2particle *_SIO2particle )
{
	_SIO2particle->loc = sio2Vec3Free( _SIO2particle->loc );
	_SIO2particle->col = sio2Vec4Free( _SIO2particle->col );
